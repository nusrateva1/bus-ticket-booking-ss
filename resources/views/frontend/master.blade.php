		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarmain">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"><a class="nav-link" href="about.html">Booking</a></li>
					<li class="nav-item"><a class="nav-link" href="service.html">sign_up</a></li>

					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="department.html" id="dropdown02" data-toggle="dropdown"
							aria-haspopup="true" aria-expanded="false">Log_in <i class="icofont-thin-down"></i></a>
...
<footer class="footer section gray-bg">
    ...
    <script src="{{url('/Frontend/js/shuffle.min.js')}}"></script>

    <!-- Google Map -->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAkeLMlsiwzp6b3Gnaxd86lvakimwGA6UA"></script>
    <script src="{{url('/Frontend/js/gmap.js')}}"></script>
